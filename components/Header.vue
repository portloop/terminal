<template>
    <div class="fixed z-10 bg-white  top-0 w-full flex flex-col">
        <div class="flex items-center justify-end w-10/12 mx-auto py-5">
            <div class="text-3xl border-r border-solid border-black/20 pr-3">TEST</div>
            <div class="flex flex-col items-center pl-3">
                <div class="text-sm">Call 0330 818 7510</div>
                <div class="bg-[#f8f4e6] flex items-center rounded-xl p-1">
                    <span class="bg-[#fa571b] w-2 mr-1 h-2 rounded-full flex"></span>
                    <span class="text-sm">Back at 9am tomorrow</span>
                </div>
            </div>
        </div>
